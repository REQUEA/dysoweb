				...
				<div class="rqportlet">
					<div class="rqview">
						<div>
							...
							<table width="100%">
                                <tr><td class="lbl"><span class="req">*</span>Authorization Key:</td><td class="val"><panel:input name="AuthKey" size="34"/>&nbsp;<a href="https://www.requea.com/do/rqRepoKeyRequest:new" target="_blank">Request an authorization key</a></td></tr>
