...
import com.requea.dysoweb.panel.bundlerepository.MapToDictionary;
...
public class RepositoryAdminImpl implements RepositoryAdmin
{
	...
	public synchronized Repository addRepository(URL url) throws Exception
    {
        ...
        Repository repo = new RepositoryImpl(url, m_sslFactory);
    ...
    public synchronized Resolver resolver()
    {
        ...
        return new ResolverImpl(m_context, this, m_sslFactory);
    }
