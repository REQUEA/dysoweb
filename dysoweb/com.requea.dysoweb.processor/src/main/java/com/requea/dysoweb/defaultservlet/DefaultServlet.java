...
import com.requea.dysoweb.org.apache.catalina.util.ServerInfo;
import com.requea.dysoweb.org.apache.catalina.util.StringManager;
import com.requea.dysoweb.org.apache.catalina.util.URLEncoder;
...
public class DefaultServlet
    ...
    public DefaultServlet(RequestProcessor processor) {
    ...
    public void init() throws ServletException {
        ...
        BundleDirContext dirContext = new BundleDirContext(fRequestProcessor);
        Hashtable env = new Hashtable();
        env.put("host", "localhost");
        env.put("context", "requea");
        resources = new ProxyDirContext(env, dirContext); 
    ...
    protected InputStream renderHtml
        ...
        sb.append("</title>\r\n");
        sb.append("<STYLE><!--");
        sb.append(com.requea.dysoweb.org.apache.catalina.util.TomcatCSS.TOMCAT_CSS);
        sb.append("--></STYLE> ");
        sb.append("</head>\r\n");
        sb.append("<body>");
        sb.append("<h1>");
