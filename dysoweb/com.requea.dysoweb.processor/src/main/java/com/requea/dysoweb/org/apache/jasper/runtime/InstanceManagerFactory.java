...
public class InstanceManagerFactory {
    ...
    public static InstanceManager getInstanceManager(ServletConfig config) {
        InstanceManager instanceManager = 
                (InstanceManager) config.getServletContext().getAttribute("com.requea.org.apache.tomcat.InstanceManager");
        if (instanceManager == null) {
        	instanceManager = new DefaultInstanceManager();
        	config.getServletContext().setAttribute("com.requea.org.apache.tomcat.InstanceManager", instanceManager);        	
        }
