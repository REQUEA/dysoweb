...
class Generator {
    ...
    private void generatePreamble(Node.Nodes page) throws JasperException {
        ...
        // SingleThreadModel was removed in Servlet 6.0; generated servlets no longer implement it.
        out.println(" {");
        out.pushIndent();
        ...
        out.println("        throws java.io.IOException, jakarta.servlet.ServletException {");
